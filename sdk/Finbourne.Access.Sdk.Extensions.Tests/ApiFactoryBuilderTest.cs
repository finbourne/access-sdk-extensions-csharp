    ...
    public class ApiFactoryBuilderTest
    {
        ...
        public void CreateDummySecretsFile()
        {
            ...
            var secrets = new Dictionary<string, object>
            {
                ...
                {
                    {string.Format("{0}Url", "access"), "https://sub-domain.lusid.com/api"},
        ...
        //Test requires [assembly: InternalsVisibleTo("Finbourne.Access.Sdk.Extensions.Tests")] in ClientCredentialsFlowTokenProvider
        [Test]
